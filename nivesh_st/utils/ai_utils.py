...
DEFAULT_MODEL = "gemini-3.1-pro"  # Gemini 3.1 Pro — most intelligent (2026)
...
MODEL_CASCADE = [
    "gemini-3.1-pro",            # Most intelligent — complex reasoning, coding, agentic
    "gemini-3.0-flash",          # High-speed, cost-effective, general purpose
    "gemini-3.1-flash-lite",     # High-throughput, latency-sensitive, cost-efficient
...
def list_models() -> list:
    try:
        ...
        return [
            {"id":"gemini-3.1-pro",       "name":"Gemini 3.1 Pro ⭐ (2026 — Most intelligent)"},
            {"id":"gemini-3.0-flash",     "name":"Gemini 3 Flash (2026 — Fast & cost-effective)"},
            {"id":"gemini-3.1-flash-lite","name":"Gemini 3.1 Flash Lite (2026 — Fastest, lowest cost)"},
