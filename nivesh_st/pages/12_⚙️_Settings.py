...
MODELS = [
    ...
    {"id": "gemini-3.0-flash",              "name": "Gemini 3 Flash",             "tier": "⚡ 2026", "note": "Fast & cost-effective · General purpose"},
      {"id": "gemini-2.5-pro",               "name": "Gemini 2.5 Pro",             "tier": "✅ 2025", "note": "Production-stable fallback"},
      {"id": "gemini-1.5-pro",               "name": "Gemini 1.5 Pro",             "tier": "🔄 Legacy","note": "Always works if 2026 models unavailable"},
...
if st.button("🔄 Reset — Auto-detect Best Model", help="Clears saved model. NIVESH auto-picks the best available Gemini model for your key."):
    if "gemini_model" in st.session_state:
        del st.session_state["gemini_model"]
    st.success("Reset! NIVESH will auto-detect the best available Gemini model.")
    st.rerun()
st.caption("Use Reset if you see '404 model not found' or 'model deprecated' errors.")
