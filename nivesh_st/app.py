...
# ── Clear deprecated Gemini models from session state on every load ────────
# This runs before any page content, ensuring stale model IDs never persist
_DEPRECATED = {"gemini-2.0-flash","gemini-2.0-flash-exp","gemini-2.0-pro",
               "gemini-1.0-pro","gemini-1.0-pro-latest","gemini-2.0-flash-lite"}
if st.session_state.get("gemini_model") in _DEPRECATED:
